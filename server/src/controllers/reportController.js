...
exports.downloadPDF = async (req, res) => {
    try {
        ...
        // Header
        doc.fontSize(24).fillColor("#6366f1").text("LieDetector AI", { align: "center" });
        doc.moveDown(0.3);
        ...
        // Footer
        doc.moveDown(1);
        doc.fontSize(8).fillColor("#aaa").text("This report was generated by LieDetector AI. Results are AI-powered estimates and should not be used as the sole basis for hiring decisions.", { align: "center" });
